// Google Ads Conversion Tracking - DAMAC Islands 2
...
(function () {
  ...
  if (form) {
    form.addEventListener('submit', (e) => {
      ...
      const message =
        'Hi%2C+I+want+Priority+Allocation+for+DAMAC+ISLANDS+2+and+the+launch-phase+pricing.%0A%0A' +
  ...
  if (heroForm) {
    heroForm.addEventListener('submit', (e) => {
      ...
      const message =
        'Hi%2C+I+want+the+DAMAC+ISLANDS+2+launch+price+and+Priority+Allocation.%0A%0A' +
        'Name%3A+' + encodeURIComponent(name) + '%0A' +
        'Mobile%3A+%2B91+' + encodeURIComponent(mob);
...
// ============================================================
// AUTO IMAGE COMPRESSION - DAMAC Islands 2
